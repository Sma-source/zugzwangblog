  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-5 p-5 xl:p-0">
      {[1, 2, 3, 4, 5]?.map((_, index) => {
        return (
          <div
            className="w-full  border-0 rounded-md bg-[#F2DFCE] dark:bg-graident-dark p-5 hover:ring-2 ring-[#F2DFCE] transition-all cursor-pointer space-y-5 first:lg:col-span-2 first:md:col-span-3"
            key={index}
          >
